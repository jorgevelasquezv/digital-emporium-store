...
const Contact = () => {
    return (
        <main className="max-w-screen-lg mx-auto p-5">
            <section className="grid grid-cols-1 md:grid-cols-12 border">
                <article className="bg-blue-800 md:col-span-4 p-10 text-white">
                    <p className="mt-4 text-sm leading-7 font-regular uppercase">
                        Contact
                    </p>
                    <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                        Digital Emporium <span className="text-gray-500">Store</span>
                    </h3>
